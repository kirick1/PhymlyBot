...
module.exports = {
    getChooseGroupButtons: () => Markup.inlineKeyboard([
        Markup.callbackButton('0-А','0A'),Markup.callbackButton('0-Б','0B'),
        Markup.callbackButton('1-А','1A'),Markup.callbackButton('1-Б','1B'),
        ...
        Markup.callbackButton('4-А','4A'),Markup.callbackButton('4-Б','4B')],{columns:3}).extra(),
